...
np.save("AUC_TEST_mean_prediction",AUC_TEST_mean)
np.save("AUC_TEST_std_prediction",AUC_TEST_std)
np.save("TRUE_POSITIVE_mean_prediction",TRUE_POSITIVE_mean)
np.save("TRUE_POSITIVE_std_prediction",TRUE_POSITIVE_std)
np.save("TRUE_NEGATIVE_mean_prediction",TRUE_NEGATIVE_mean)
np.save("TRUE_NEGATIVE_std_prediction",TRUE_NEGATIVE_std)